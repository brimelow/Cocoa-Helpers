...
@implementation BezierLayoutManager
...
- (void)showPackedGlyphs:(char *)glyphs length:(unsigned long)glyphLen
...
- (NSBezierPath *)bezierWithFont: (NSFont*) theFont {
	...
	BezierLayoutManager *myLayout = [[BezierLayoutManager alloc] init];
